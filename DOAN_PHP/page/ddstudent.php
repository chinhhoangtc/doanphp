    ...
    <div class="container my-3 border rounded-2 box-ddlh p-3" style="background-color: white;">
        ...
        <form method="POST" action="save_attendance.php">
            ...
            <div class="">
                ...
                <?php endif; ?>
                <a href="export_to_excel.php?attendance_id=<?php echo $attendance_id; ?>" class="btn btn-primary <?php echo !$is_submit ? 'disabled' : ''; ?>">Xuất excel</a>
            </div>
        </form>
    </div>

    <!-- Liên kết tới jQuery và Bootstrap JS CDN -->
</body>
